...
<div class="row justify-content-center">
    <div class="col-md-8">
        <div class="card">
            ...
            <div class="card-body">
            <form method="post" action="{{url('edit_task/'.$result->id)}}" id="taskForm">
                @csrf
            <div class="form-group">
                <label>Team Member<span class="error">*</span></label>
                {!! Form::select('team', $user, $result->user_id, ['class' => 'form-control', 'placeholder' => 'Select']) !!}
                <span class="text-danger">{{$errors->first('team')}}</span>                                
            </div>            
            <div class="form-group">
                <label>Project<span class="error">*</span></label>
                {!! Form::select('project', $project, $result->project_id, ['class' => 'form-control', 'placeholder' => 'Select']) !!}
